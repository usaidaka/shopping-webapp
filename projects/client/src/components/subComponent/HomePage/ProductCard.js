        ...
        {productData.data?.map((product) => (
          ...
          >
            <Link to={`/products/${product.id}`} className="bg-inherit">
              <div
                key={product.id}
                className="grid grid-rows-13 lg:grid-rows-3 lg:grid-cols-3 h-[260px] lg:h-[150px] w-[160px] lg:w-[500px] rounded-md shadow-lg bg-inherit"
              >
                <div className="row-span-8 lg:row-span-3 lg:col-span-1 flex justify-center bg-inherit">
                  <img
                ...
                <div className="row-span-2 lg:row-span-1 lg:col-span-2 w-[160px] lg:w-auto bg-inherit">
                  <p className="font-bold px-[10px] whitespace-nowrap overflow-hidden text-ellipsis py-auto lg:mt-[13px] bg-inherit">
                    {product.name_item}
                  </p>
                </div>
                <div className="row-span-2 lg:row-span-1 lg:col-span-2 w-[160px] lg:w-auto bg-inherit">
                  <p className="px-[10px] whitespace-nowrap overflow-hidden text-ellipsis py-auto lg:mt-[13px] bg-inherit">
                    {product.product_description}
                  </p>
                </div>
                <div className="row-span-1 lg:row-span-1 lg:col-span-2 w-[160px] lg:w-auto bg-inherit">
                  <p className="font-bold px-[10px]  py-auto text-green-400 lg:mt-[13px] bg-inherit">
