...
export const ProductCard = (props) => {
  ...
  return (
    <>
      <div className="w-full lg:w-auto flex gap-6 flex-wrap justify-center mx-auto after:w-40 lg:after:w-[500px] mb-20">
        {productData.data?.map((product) => (
          ...
          >
            <Link to={`/products/${product.id}`} className="bg-inherit">
              <div
                key={product.id}
                className="grid grid-rows-13 lg:grid-rows-4 lg:grid-cols-3 h-65 lg:h-38 w-40 lg:w-[500px] rounded-md shadow-lg bg-inherit"
              >
                <div className="row-span-8 lg:row-span-4 lg:col-span-1 flex justify-center bg-inherit">
                  <img
                    src={product.image_product}
                    alt="product"
                    className="h-40 lg:h-38 bg-inherit"
                  />
                </div>
                <div className="row-span-2 lg:row-span-1 lg:col-span-2 w-40 lg:w-auto bg-inherit">
                  <p className="font-bold px-[10px] whitespace-nowrap overflow-hidden text-ellipsis py-auto lg:mt-1 bg-inherit">
                    {product.name_item}
                  </p>
                </div>
                <div className="row-span-1 lg:row-span-1 lg:col-span-2 w-40 lg:w-auto bg-inherit">
